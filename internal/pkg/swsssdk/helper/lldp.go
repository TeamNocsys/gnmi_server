...
type Lldp struct {
    ...
    Data *sonicpb.SonicLldp_Lldp_LldpList
}
...
func (c *Lldp) LoadFromDB(flags uint) error {
    ...
    // 获取配置信息
    if c.Data == nil {
        c.Data = &sonicpb.SonicLldp_Lldp_LldpList{}
    }
    // 加载配置数据
    // 是否加载状态数据
    if (flags & DATA_TYPE_STATE) != 0 {
        if c.Data.State == nil {
            c.Data.State = &sonicpb.SonicLldp_Lldp_LldpList_State{}
        }
            ...
            for k, v := range data {
                ...
                case "lldp_rem_port_id_subtype":
                    if i, err := strconv.ParseUint(v, 10, 64); err != nil {
                        ...
                        c.Data.State.LldpRemPortIdSubtype = sonicpb.SonicLldp_Lldp_LldpList_State_LldpRemPortIdSubtype(i)
                    }
                ...
                case "lldp_rem_chassis_id_subtype":
                    if i, err := strconv.ParseUint(v, 10, 64); err != nil {
                        ...
                        c.Data.State.LldpRemChassisIdSubtype = sonicpb.SonicLldp_Lldp_LldpList_State_LldpRemChassisIdSubtype(i)
                    }
